...
CREATE TABLE `appt` (
  ...
  CONSTRAINT `appt_ibfk_2` FOREIGN KEY (`vin`) REFERENCES `cars` (`vin`)
...
INSERT INTO `appt` VALUES ('Jdoe11','2SG3GSBEJ23'),('Jdoe11','4H35OAN821AS1NF'),('Jdoe11','72SJ24UGF4JFSF');
...
-- Dump completed on 2018-03-21  1:30:19
